...
moon({
  ...
  async execute(sock, jid, sender, args, m, { reply }) {
    try {
      ...
      if (!mentionedJid) {
        return reply("❌ Tag someone to punch! Example: .punch @user");
      }
      ...
      await sock.sendMessage(jid, {
        video: buffer,
        caption: `👊 *@${sender.split("@")[0]}* punched *@${mentionedJid.split("@")[0]}*!`,
        gifPlayback: true,
        mimetype: 'video/mp4',
      ...
      reply("❌ Failed to send punch. Please try again later.");
    }
  }
});
